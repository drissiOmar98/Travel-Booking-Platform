...
public class SecurityUtils {
     ...
     *
     * @param attributes The attributes map from the OAuth2 provider.
     * @return A User entity populated with attributes.
     */
    public static User mapOauth2AttributesToUser(Map<String, Object> attributes) {
        ...
        // Extracting roles and authorities
     ...
     *
     * @param claims The claims map from the JWT token.
     * @return A list of SimpleGrantedAuthority based on roles in claims.
     */
    ...
    /**
     * Retrieves the roles from the JWT claims.
     *
     * @param claims The claims map.
     * @return A collection of roles extracted from claims.
     */
    ...
    /**
     * Maps roles to Spring Security's SimpleGrantedAuthority objects.
     *
     * @param roles A collection of role names.
     * @return A list of SimpleGrantedAuthority corresponding to roles.
     */
    ...
    /**
     * Retrieves authorities from the authentication object.
     *
     * @param authentication The Authentication object.
     * @return A stream of authority names.
     */
